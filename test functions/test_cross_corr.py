...
x2 = numpy.array([18.00751528, 15.85091013, 12.74821481, 8.84938525, 4.34429888, -0.54676661, -5.58417895, -10.5209674,
                  -11.86736426, -12.95560465, -13.72549351, -14.13279923, -14.15147163, -13.77494825, -13.01648336])
y = numpy.array([0, 0.5, 0.5, 0.5, 0])
y2 = numpy.array([9.87463956e-01, 1.43794839e+00, 1.32886413e+00, 1.15314508e+00,
...
def test_cross_corr(candidate, expected):
    """
    This test checks if the values in a given numpy array and its pre-anticipated result of cross_correlation are
    almost the same.
    """
